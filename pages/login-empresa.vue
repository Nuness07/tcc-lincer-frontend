    ...
    <div class="login__right">
      <div class="login__right-infos">
        ...
        <div class="login__right-infos-title">
          ...
          <p>Para acessar e controlar seus alugueis</p>
        </div>
        ...
        <p class="signup">
          Ainda não tem cadastro?<nuxt-link class="to-signup" to="/cadastro-empresa">
...
export default {
  ...
  methods: {
    ...
    async login (values) {
      try {
        await this.$auth.loginWith("localCompany", {
          data: {
            email: values.email,
...
.login {
  ...
  &__left {
    background: url("@/assets/img/login-register-company-bg.png") no-repeat;
